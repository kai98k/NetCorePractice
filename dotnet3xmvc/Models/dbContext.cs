...
namespace dotnet3xmvc.Models
{
    public partial class dbContext : DbContext
    {
        ...
        public virtual DbSet<ViewSalesByCategory> ViewSalesByCategory { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=MCSDD11101-6;Initial Catalog=Northwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ViewSalesByCategory>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("viewSalesByCategory");
